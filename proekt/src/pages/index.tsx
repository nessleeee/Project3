...
import { AccessoriesType, BannerType, BrandType, CategoryType, ProductType } from "@/types/types";
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const accessories: AccessoriesType[] = await resAccessories.json();
    ...
    const resThreeProducts = await fetch("http://localhost:8000/products/?_limit=3.");
